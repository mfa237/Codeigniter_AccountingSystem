...
var editor;
    ...
    //add icons
    $("#ToolTables_crudtable_0").prepend('<i class="ti ti-plus"/> ');
    $("#ToolTables_crudtable_1").prepend('<i class="ti ti-pencil"/> ');
    $("#ToolTables_crudtable_2").prepend('<i class="ti ti-close"/> ');
    ...
    $('#panel-editable .panel-ctrls').append($('#panel-editable .DTTT.btn-group').addClass("pull-left mt-sm"));
