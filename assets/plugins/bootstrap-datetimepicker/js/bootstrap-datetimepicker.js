...
!function ($) {
	...
	var Datetimepicker = function (element, options) {
		...
		this.component = this.element.is('.date') ? ( this.bootcssVer == 3 ? this.element.find('.input-group-addon .fa-th, .input-group-addon .fa-clock-o, .input-group-addon .fa-calendar').parent() : this.element.find('.add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar').parent()) : false;
