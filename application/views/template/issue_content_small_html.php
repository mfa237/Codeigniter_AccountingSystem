...
<h4 style="font-weight:bold;">DELIVERY RECEIPT FOR SMALL<slipno style="float:right;"><?php echo $issuance_info->slip_no; ?></slipno></h4>
<table class="table">
    <thead>
    </thead>
    <tbody>
...
<table style="font-family:tahoma;" class="table">
    <thead>
        <tr>
