...
<div class="row">
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12">
                <h1 class="text-center" style="font-weight: 600;"><center>EVR Vet-Options Corporation</center></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12">
                ...
                <?php } else { ?>
                    <h4 style="font-weight: 400;"><strong>DELIVERY RECEIPT</strong></h4>
                <?php } ?>
            </div>
        </div>
            <table class="" width="100%" border="1" cellspacing="0">
                <tr>
                    <td class="table-cellpadding" width="10%"><strong>Sold to :</strong></td>
                    <td class="table-cellpadding" width="40%">&nbsp;<?php echo $sales_info->department_name; ?></td>
                    <td class="table-cellpadding" width="10%"><strong>Date :</strong></td>
                    <td class="table-cellpadding" width="10%">&nbsp;<?php echo  date_format(new DateTime($sales_info->date_invoice),"m/d/Y"); ?>&nbsp;</td>
                    <td class="table-cellpadding" width="10%"><strong>&nbsp;Ref. # :</strong></td>
                    <td class="table-cellpadding" width="20%">&nbsp;<?php echo $sales_info->remarks; ?></td>
                </tr>
                <tr>
                    <td class="table-cellpadding" width="10%"><strong>Address :</strong></td>
        ...
        <table width="100%" cellpadding="10" cellspacing="0" class="table-border" border="1">
            <thead>
                <tr>
                    ...
                    <th width="30%" class="table-cellpadding tbl-border-si tbl-center" style="padding: 0;"><strong>AMOUNT</strong></th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                ?>
                <tr>
                    <td width="30%" class=" tbl-border-si" style="padding: 5px; font-size: 12px;"><?php echo $item->product_desc; ?><br>
                ...
                <tr>
                    <td class="table-cellpadding" width="50%"><center>Prepared by</center></td>
                    <td class="table-cellpadding" colspan="4" width="50%"><center>Received by</center></td>
                </tr>
            </tbody>
        </table>
    </div>
