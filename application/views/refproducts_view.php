...
<div id="wrapper">
            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin:0;">
                        ...
                        <li><a href="Refproducts">Product Type</a></li>
                    </ol>
 ...
 -->
                                    <!--         <div class="panel-body">
                                                <h2>Unit Information</h2>
                                                <form id="frm_product_type" role="form" class="form-horizontal row-border">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header modal-erp">
                            <h4 id="prodtype_title" class="modal-title" style="color: white;"></h4>
                        </div>
                        <div class="modal-body">
                            <form id="frm_product_type" role="form" class="form-horizontal row-border">
                                <div class="form-group">
                                    <label class="col-md-3 col-md-offset-1 control-label"><strong>* Product Type :</strong></label>
                                    <div class="col-md-7">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="fa fa-cube"></i>
                                            </span>
                                            <input type="text" name="product_type" class="form-control" placeholder="Product Type" data-error-msg="Product Type is required!" required>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_product_type').DataTable({
            "dom": '<"toolbar">frtip',
            "bLengthChange":false,
            "ajax" : "Refproducts/transaction/list",
            "columns": [
                { targets:[0],data: "product_type" },
        ...
        var createToolBarButton=function(){
            var _btnNew='<button class="btn btn-green"  id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="New unit" >'+
                '<i class="fa fa-cube"></i> New Product Type</button>';
    ...
    var bindEventHandlers=(function(){
        ...
        $('#btn_new').click(function(){
            _txnMode="new";
            $('#prodtype_title').text('New Product Type');
    ...
    var clearFields=function(){
        $('input,textarea,select','#frm_product_type').val('');
