            ...
            <div class="static-content"  >
                ...
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;">
                        ...
                        <li><a href="Customer_Subsidiary">Customer Subsidiary</a></li>
                    </ol>
    ...
    $(document).ready(function(){
        ...
        var bindEventControls=function(){
            ...
            $(document).on('click','#btn_print',function(){
                window.open('Templates/layout/customer-subsidiary?type=preview&customerId='+_cboCustomers.val()+'&accountId='+_cboAccounts.val()+'&startDate='+_date_from.val()+'&endDate='+_date_to.val());
        ...
        function reloadList(){
            ...
            dt=$('#tbl_customer_subsidiary').DataTable({
                ...
                "bPaginate":false,
                "ajax": {
                    "url": "Customer_Subsidiary/transaction/get-customer-subsidiary",
                    "type": "GET",
                    "bDestroy": true,
                    "data": function ( d ) {
                        return $.extend( {}, d, {
