                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-group" style="z-index: 99999">
                                                ...
                                                <input type="text" name="date_filter" id="dt_start_date" class="date-picker form-control" value="01/01/<?php echo date("Y"); ?>" placeholder="Start Date" data-error-msg="Start date is required!" required>
