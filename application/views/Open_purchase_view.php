...
$(document).ready(function(){
    var dt; 
       ...
       var bindEventHandlers=function(){
        ...
        $('#btn_print').click(function(){
            window.open('Open_purchase/transaction/report');
        });
    }();
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_delivery_invoice').DataTable({
            ...
            "ajax" : "Open_purchase/transaction/list2",
            "columns": [
                {
                     targets:[0],data: "po_no" 
                },
                { targets:[1],data: "last_date_delivered" },
                { targets:[2],data: "product_code" },
                { targets:[3],data: "product_desc" },
                { targets:[4],data: "PoQtyTotal" },
                { targets:[5],data: "PoQtyDelivered" },
                { targets:[6],data: "PoQtyBalance" }
